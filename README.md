...
- **Jenis Repository**   : jenis repository  dibagi menjadi **Public** dan **Private**. Ketika Anda mengatur repository menjadi **Public**, orang 

lain dapat melihat repository yang Anda buat. Sebaliknya, jika Anda mengaturnya sebagai Private, repository tersebut hanya bisa diakses oleh Anda.
